...
func Run(schedule Runner, maxDepth int) float64 {
...
func NewStep(function func(i int) float64, input int) Runner {
...
func NewSequence(sequences ...Runner) Runner {
...
func NewLoop(schedule Runner, maxDelta float64) Runner {
